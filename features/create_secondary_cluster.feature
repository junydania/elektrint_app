Feature: As an administrator
  In order to link jobs to a secondary cluster
  I should be able to populate the system with new secondary clusters
  ...
  Scenario:
    ...
    And I click on "Secondary Cluster"
    And I click on "Create Secondary Cluster"
    And I fill in field 'Cluster Name' with 'IT Operation'
    And I click on "Submit"
    Then I should see "New Secondary Cluster Successfully Added"
