Feature: As an administrator
  In order to link jobs to its work level
  I should be able to populate the system with new work levels
  ...
  Scenario:
    ...
    And I click on "Work Level"
    And I click on "Create Work Level"
    And I fill in field 'Level Name' with 'Managerial'
    And I click on "Submit"
    Then I should see "Work Level Successfully Added"
