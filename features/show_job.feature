Feature: As an administrator
  In order to correct errors in the creation of new jobs
  I should be able to edit a saved job
  ...
  Scenario:
    ...
    And I click on "Manager, It Infrastructure"
    Then I should see "Manager, It Infrastructure Job Details Page"
